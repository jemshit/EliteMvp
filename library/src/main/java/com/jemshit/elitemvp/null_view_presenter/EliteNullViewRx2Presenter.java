 ...
 * <b>CompositeDisposable</b> objects for RxJava 2 <b>Disposables</b>
 */
public class EliteNullViewRx2Presenter<V extends EliteView> extends EliteRx2Presenter<V> {
     ...
     */
    public EliteNullViewRx2Presenter(Class<V> viewType) {
