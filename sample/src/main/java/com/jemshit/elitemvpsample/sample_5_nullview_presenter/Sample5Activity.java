...
public class Sample5Activity extends AppCompatActivity implements Sample5Contract.View {

    private TextView textSum;
    private EditText input1;
    private EditText input2;

    private Sample5Contract.Presenter presenter;

    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sample_adder);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(getString(R.string.example_null_view));
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        // Initialize Presenter with View's class
        presenter = new Sample5Presenter(Sample5Contract.View.class);
        // Attach View to it
